...
int main(int argc, char **argv) {
    ...
    MPI_Datatype sCtype;//тип для хранения матрицы sC(каждая строка матрицы будет сдвинута на N2 элементов)
    ...
    MPI_Type_vector(N1 / dims[0], N2 / dims[1], N2, MPI_DOUBLE, &sCtype);
